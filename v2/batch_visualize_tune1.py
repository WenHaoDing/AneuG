"""
Batch driver to render the tune1 VAE outputs across (mode, aneurysm_type)
combinations. Mirror of batch_visualize_baselines.py but pointed at the
ghd_vae_tune1/epoch_03000.pth checkpoint.
...
CHECKPOINTS = [
    ("vae_tune1", "vae", ROOT / "checkpoints" / "v2" / "ghd_vae_tune1" / "epoch_03000.pth"),
]
