...
"""
conda activate new
python dataset/preprocess_ImperialNHS.py --dataset imperialnhs
python dataset/preprocess_ImperialNHS.py --dataset aneux --aneurysm-types 1 2 \
