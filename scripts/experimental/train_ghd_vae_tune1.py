...
SAVE_DIR = ROOT / "checkpoints" / "v2" / "ghd_vae_tune1"

DEVICE = torch.device("cuda:1" if torch.cuda.is_available() else "cpu")
EPOCHS = 3000            # tune1: was 10000
BATCH_SIZE = 128
LR = 1e-3                # tune1: was 2e-3
HIDDEN_DIM = 512
LATENT_DIM = 108
WITH_SCALE = True
KL_WEIGHT = 1e-3         # tune1: was 2.5e-4
SCALE_WEIGHT = 0.25
MESH_WEIGHT = 10.0       # tune1: was 100.0
SAVE_EVERY = 500
LOG_EVERY = 10
NUM_TYPES = 3
...
def plot_losses(log_path, plot_path):
    ...
    ax.set_title(f"VAE tune1 | mesh={MESH_WEIGHT}, kl={KL_WEIGHT}, lr={LR}")
    ax.legend()
...
"""
conda activate new
python scripts/experimental/train_ghd_vae_tune1.py
"""
